...
本文件记录 lelele 学习 Agent 的目标、项目学习取舍和课程路线。

`AGENTS.md` 负责教学协作规则；`TEACHING_PROGRESS.md` 负责动态学习进度和卡点记录。
...
- 语法基础：`append()`、`extend()`、`+=`、字典取值、`**arguments`
- 理论知识：JSON、JSON Schema、OpenAI SDK 返回对象结构
- 代码实操：观察 `response`、`response.output`、`response.output_text`，并用最小例子理解列表和 JSON Schema
